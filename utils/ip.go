...
func (*ip) GetIpAddress(c *gin.Context) (ipAddress string) {
...
func (*ip) GetIpSource(ipAddress string) string {
...
func (i *ip) GetIpSourceSimpleIdle(ipAddress string) string {
...
func (*ip) GetUserAgent(c *gin.Context) *useragent.UserAgent {
